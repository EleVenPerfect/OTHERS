...
static  void  AppTaskUsart ( void * p_arg )
{
	...
	while (DEF_TRUE) {                                           //任务体
		...
		if(state == 1)
		{
				...
				if(!(pMsg[0]==TFT480800STOP[0] || pMsg[0]==TFT480800STOP[1] || pMsg[0]==TFT480800STOPUSER[3] || pMsg[0]==TFT480800STOPPC[3]))
				{
								flag[0] = 0x0;
								flag[1] = 0x0;
								flag[2] = 0x0;
