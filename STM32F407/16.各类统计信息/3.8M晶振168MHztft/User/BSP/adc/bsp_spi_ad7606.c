...
void AD7606_Disp(void)
{
	unsigned short int i;	
	unsigned short int iTemp;
	unsigned char a[7] = {0xEE, 0xB1, 0x10, 0x00, 0x00, 0x00, 0x00};
	unsigned char b[4] = {0xFF, 0xFC, 0xFF, 0xFF };
	unsigned char c[10] = {0xEE, 0xB1, 0x32, 0x00, 0x00, 0x00, 0x09, 0x00, 0x00, 0x02};
	unsigned char d,e;
	/* 打印采集数据 */
	for (i = 0; i < CH_NUM; i++)
	{                
