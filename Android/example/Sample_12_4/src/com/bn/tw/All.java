...
public class All extends Activity {
    ...
    { 
        ...
        TextView website = (TextView)findViewById(R.id.website_all);		//获得WebView对象
		...
		(
			new View.OnClickListener()
			{
				...
				public void onClick(View v)
				{
					...
					{
						Toast.makeText(All.this, "对不起，您现在不能前进！", Toast.LENGTH_SHORT).show();
					}
				}
			}
		);
		...
		(
			new View.OnClickListener()
			{
				...
				public void onClick(View v)
				{
					...
					{
						Toast.makeText(All.this, "对不起，您现在不能后退！", Toast.LENGTH_SHORT).show();
					}
				}
			}
		);
